        ...
        <form  class=' flex flex-col p-5 gap-5' wire:submit='store'>
            <div class='flex flex-col gap-2'>
                ...
                <x-form-input wire:model='treasury_name' type="text" name='treasury_name' id='treasury_name'
                    placeholder='اسم الخزنة'  required/>
            ...
            <div class='flex flex-col gap-2'>
                ...
                <x-form-input wire:model='treasury_number'  type="number" name='treasury_number' id='treasury_number'
                    placeholder='رقم الخزنة' min='1'required />
                <x-form-error name='treasury_number' />
            </div>

            <div class='flex flex-col gap-2'>
                <x-form-label name='treasury_location'>موقع الخزنة</x-form-label>
                <textarea  wire:model='treasury_location' type="text" name='treasury_location' id='treasury_location' class='bg-slate-200 p-3' required></textarea>
