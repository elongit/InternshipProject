<fieldset class='w-full md:w-2/3  m-auto my-10  shadow-md  rounded'>
        <legend class='text-xl font-semibold p-2'>إضافة قسم</legend>
        <form  class='flex flex-col  p-5 gap-5' wire:submit='store'>
            ...
            <div class='flex flex-col  gap-2'>
                ...
                <textarea wire:model='division_location' type="text" name='division_location' id='division_location' class='bg-slate-200 p-3'> </textarea>
